...
(
	[Id-Usuario] int NOT NULL,
	[Id-Bicho] int NOT NULL,
	[Id-Ubicacion] smallint NOT NULL,
	[Fecha] date NOT NULL
)
;
...
ALTER TABLE [EVOLUCION] 
 ADD CONSTRAINT [PK_EVOLUCION_UNICA] UNIQUE NONCLUSTERED ([Evolucion],[ID-Especie],[ExperenciaNecesaria])
;
...
ALTER TABLE [RONDA] 
 ADD CONSTRAINT [RONDA_UNIC] UNIQUE NONCLUSTERED ([Id-Combate],[NumeroRonda])
;
...
CREATE INDEX [IXFK_USUARIO-CAPTURA-BICHO_UBICACION] 
 ON [USUARIO-CAPTURA-BICHO] ([Id-Ubicacion] ASC)
;
...
ALTER TABLE [EVOLUCION] ADD CONSTRAINT [FK_EVOLUCION_ESPECIE]
	FOREIGN KEY ([Evolucion]) REFERENCES [ESPECIE] ([ID]) ON DELETE No Action ON UPDATE No Action
;
...
ALTER TABLE [USUARIO-CAPTURA-BICHO] ADD CONSTRAINT [FK_USUARIO-CAPTURA-BICHO_UBICACION]
	FOREIGN KEY ([Id-Ubicacion]) REFERENCES [UBICACION] ([Id]) ON DELETE No Action ON UPDATE No Action
;
