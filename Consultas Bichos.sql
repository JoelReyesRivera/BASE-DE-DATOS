...
INTERSECT
SELECT UBC.[ID-Bicho1] FROM [USUARIO-BICHO-COMBATE]  UBC
INTERSECT
SELECT UBC.[ID-Bicho2] FROM [USUARIO-BICHO-COMBATE]  UBC
INTERSECT
SELECT UBC.[ID-Bicho3] FROM [USUARIO-BICHO-COMBATE]  UBC
EXCEPT 
...
SELECT B.ID,B.Nombre,COUNT(UBC.[ID-Bicho1]) [CANTIDAD]FROM BICHO B INNER JOIN [USUARIO-BICHO-COMBATE] UBC
ON B.ID=UBC.[ID-Bicho1] OR B.ID=[ID-Bicho2] OR B.ID=[ID-Bicho3]
group by B.ID,B.Nombre
HAVING count(UBC.[ID-Bicho1]) >= 2
...
ON B.ID=UBC.[ID-Bicho1] OR B.ID=UBC.[ID-Bicho2] OR B.ID=UBC.[ID-Bicho3] INNER JOIN COMBATE C ON C.ID=UBC.[ID-Combate]
WHERE B.ID=10
...
SELECT B.ID,B.Nombre,C.ID AS COMBATE FROM BICHO B INNER JOIN [USUARIO-BICHO-COMBATE] UBC ON B.ID=UBC.[ID-Bicho1] OR B.ID=UBC.[ID-Bicho2] OR B.ID=UBC.[ID-Bicho3]
INNER JOIN COMBATE C ON C.ID=UBC.[ID-Combate]
--CONSULTA 19 MOSTRAR TODOS LOS ATAQUES QUE UTILIZO X BICHO EN SUS COMBATES
SELECT B.ID,B.Nombre,C.ID AS COMBATE,R.ID AS Ronda,R.NúmeroRonda,A.Descripción,A.Daño FROM BICHO B INNER JOIN [USUARIO-BICHO-COMBATE] UBC ON B.ID=UBC.[ID-Bicho1] OR B.ID=UBC.[ID-Bicho2] OR B.ID=UBC.[ID-Bicho3]
INNER JOIN COMBATE C ON C.ID=UBC.[ID-Combate]
